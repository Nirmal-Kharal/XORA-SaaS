...
return()=>{
  ...
  return (
    <header className={clsx("fixed w-full left-0 top-0 z-50 py-10 transition-all duration-300 max-md:py-4", hasScrolled &&'py-2 bg-black-100 backdrop-blur-[8px] ')}>
      <div className="container flex h-14 items-center max-lg:px-5">
        ...
        <button className="lg:hidden z-2  size-10 border-2 border-s4/25  rounded-full
        flex justify-center items-center" onClick={()=>setIsOpen((prev)=> !prev)}>
          <img
